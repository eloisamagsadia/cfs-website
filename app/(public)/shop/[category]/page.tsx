...
const COLORS:Record<string,string>={apparel:"#1A8040",photocards:"#156530",accessories:"#1A8040",bundles:"#CC3344",default:"#1A8040"};
                ...
                <div style={{position:"relative",padding:"4px 4px 8px 0"}}>
                  ...
                  <div style={{position:"relative",background:"#FFFFFF",border:"2px solid #DDE8DD",borderRadius:"12px",overflow:"hidden",zIndex:1}}>
                    <div style={{height:"220px",background:"#F2F7F2",overflow:"hidden",position:"relative"}}>
                      ...
                      {p.stock===0&&<div style={{position:"absolute",inset:0,background:"rgba(8,15,6,0.7)",display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{fontFamily:R,fontSize:"13px",color:"#CC3344",background:"#3D0A18",border:"1.5px solid #CC3344",borderRadius:"6px",padding:"6px 14px",letterSpacing:"1px"}}>OUT OF STOCK</span></div>}
                    ...
                    <div style={{padding:"14px 16px"}}>
                      ...
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                        ...
                        <span style={{fontFamily:R,fontSize:"11px",color:"#1A8040",background:"#E8F0E4",border:"1.5px solid #DDE8DD",borderRadius:"6px",padding:"5px 12px",letterSpacing:"1px"}}>VIEW →</span>
                      </div>
                    </div>
                  </div>
                </div>
