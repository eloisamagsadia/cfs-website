...
if (!settings) return <div style={{ padding: "8px 0" }}><SkeletonPage /></div>;
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "720px" }}>
      <div>
        <h1 style={{ fontFamily: R, fontSize: "1.6rem", color: "#156530", letterSpacing: "3px", marginBottom: "4px" }}>SITE SETTINGS</h1>
      ...
      <div style={{ background: "#FFFFFF", border: "2px solid #1A8040", borderRadius: "12px", padding: "20px", display: "flex", flexDirection: "column", gap: "12px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          <button onClick={toggleAnnouncement} style={{ fontFamily: R, fontSize: "11px", background: settings.announcement_active ? "#CC3344" : "#1A8040", color: "#F7FAF5", border: "none", borderRadius: "6px", padding: "7px 14px", cursor: "pointer", letterSpacing: "1px" }}>
