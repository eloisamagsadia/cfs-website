...
export default async function SuperCommandCenter() {
  ...
  const quickActions = [
    { label: "MANAGE ROLES", href: "/super/roles", color: "#FFFFFF", bg: "#1B3A2D" },
    { label: "BROADCAST", href: "/super/broadcast", color: "#FFFFFF", bg: "#1B3A2D" },
    { label: "SITE SETTINGS", href: "/super/settings", color: "#FFFFFF", bg: "#1B3A2D" },
    { label: "AUDIT LOG", href: "/super/audit", color: "#FFFFFF", bg: "#1B3A2D" },
  ];
