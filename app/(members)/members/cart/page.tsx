    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      {items.length === 0 ? (
        <div style={{ background: "#FFFFFF", border: "2px solid #DDE8DD", borderRadius: "12px", padding: "48px 24px", textAlign: "center" }}>
          ...
          <Link href="/shop" style={{ fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "12px", fontWeight: 700, color: "#ffffff", background: "#1A8040", textDecoration: "none", border: "1.5px solid #1A8040", borderRadius: "10px", padding: "11px 22px", letterSpacing: "1.5px", boxShadow: "0 2px 8px rgba(26,128,64,0.25)", display: "inline-flex", alignItems: "center", gap: "8px" }}>BROWSE SHOP →</Link>
        </div>
      ) : (
