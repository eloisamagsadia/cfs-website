  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <div>
        ...
        <h1 style={{ fontFamily: R, fontSize: "1.6rem", color: "#1B3A2D", letterSpacing: "3px", marginBottom: "4px" }}>MY ACTIVITY</h1>
        <p style={{ fontFamily: B, fontSize: "13px", color: "#4A7C59" }}>Your comments and reactions across the community.</p>
      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          {comments.map((c: any) => (
            <Link key={c.id} href={`/members/community/${c.post_id}`} style={{ textDecoration: "none" }}>
              <div style={{ background: "#FFFFFF", border: "1.5px solid #DDE8DD", borderRadius: "10px", padding: "14px 16px" }} className="card-hover">
                <div style={{ fontFamily: B, fontSize: "12px", color: "#5A7A60", marginBottom: "6px", letterSpacing: "0.5px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          {reactions.map((r: any) => (
            <Link key={r.id} href={`/members/community/${r.post_id}`} style={{ textDecoration: "none" }}>
              <div style={{ background: "#FFFFFF", border: "1.5px solid #DDE8DD", borderRadius: "10px", padding: "14px 16px", display: "flex", alignItems: "center", gap: "12px" }} className="card-hover">
                <span style={{ fontSize: "24px" }}>{REACTION_EMOJI[r.reaction_type] ?? "❤️"}</span>
                <div style={{ flex: 1 }}>
                  <div style={{ fontFamily: B, fontSize: "13px", color: "#1B3A2D" }}>Reacted to a post</div>
