  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:"20px" }}>
      <div>
        ...
        <p style={{ fontFamily:B, fontSize:"13px", color:"#8AAA78" }}>{display.length} ticket{display.length !== 1 ? "s" : ""}</p>
      </div>

      {display.length === 0 ? (
        <div style={{ background:"#1A2614", border:"2px solid #2C4820", borderRadius:"12px", padding:"48px 24px", textAlign:"center" }}>
          <div style={{ fontSize:"40px", marginBottom:"12px" }}>🎫</div>
          <div style={{ fontFamily:R, fontSize:"14px", color:"#5A7A50", letterSpacing:"2px", marginBottom:"16px" }}>NO TICKETS YET</div>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:"10px" }}>
          {display.map((ticket: any) => {
            ...
            return (
              <div key={ticket.id} style={{ background:"#1A2614", border:"2px solid #2C4820", borderRadius:"12px", padding:"18px 20px", display:"flex", gap:"16px", alignItems:"center" }}>
                {/* Date box */}
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  ...
                  <div style={{ fontFamily:B, fontSize:"12px", color:"#8AAA78", marginBottom:"6px" }}>{event?.location ?? "TBA"}</div>
                  <div style={{ display:"flex", gap:"8px", flexWrap:"wrap", alignItems:"center" }}>
                    ...
                    <span style={{ fontFamily:R, fontSize:"11px", color:"#F0EAD6", background:"#243520", border:"1px solid #2C4820", borderRadius:"6px", padding:"2px 10px", letterSpacing:"1px" }}>{ticket.ticket_number}</span>
                  </div>
                </div>
