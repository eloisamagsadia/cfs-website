...
export default function ExclusivePage() {
  ...
  if (error === "Sponsors only") return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 24px", textAlign: "center", gap: "16px" }}>
      ...
      <h1 style={{ fontFamily: R, fontSize: "1.4rem", color: "#1B3A2D", letterSpacing: "3px" }}>SPONSORS ONLY</h1>
          ...
          {filtered.map(item => (
            ...
            >
              <div style={{ position: "relative", height: "180px", background: "#F7FAF5" }}>
                ...
                {item.type === "video" && (
                  <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "8px", background: "#FFFFFF" }}>
                    {item.thumbnail_url
              ...
              <div style={{ padding: "12px 14px" }}>
                <div style={{ fontFamily: R, fontSize: "13px", color: "#1B3A2D", marginBottom: "4px" }}>{item.title}</div>
                {item.description && <div style={{ fontFamily: B, fontSize: "11px", color: "#5A7A60" }}>{item.description}</div>}
              </div>
            </div>
          ))}
        </div>
        ...
        <div onClick={() => setSelected(null)}
          ...
          <div onClick={e => e.stopPropagation()}
            ...
            <div style={{ padding: "16px 20px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                <div style={{ fontFamily: R, fontSize: "15px", color: "#1B3A2D", marginBottom: "4px" }}>{selected.title}</div>
