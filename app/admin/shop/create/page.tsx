    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px", maxWidth: "720px" }}>
      ...
      <div style={{ display: "flex", gap: "12px" }}>
        <button onClick={handleSubmit} disabled={loading} style={{ position: "relative", display: "inline-block", cursor: loading ? "not-allowed" : "pointer", opacity: loading ? 0.7 : 1 }}>
          ...
          <span style={{ position: "relative", display: "block", fontFamily: R, fontSize: "12px", background: "#1A8040", color: "#ffffff", padding: "10px 28px", border: "2px solid #1B3A2D", borderRadius: "6px", letterSpacing: "1.5px" }}>{loading ? "SAVING..." : "CREATE PRODUCT"}</span>
        </button>
