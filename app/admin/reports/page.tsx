        ...
        {(reports ?? []).map((r: any) => (
          <div key={r.id} style={{ background: "#FFFFFF", border: "2px solid #DDE8DD", borderRadius: "12px", padding: "14px 20px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "12px" }}>
            ...
            <div style={{ display: "flex", gap: "8px", alignItems: "center", flexShrink: 0 }}>
              {r.pdf_url && (
                <a href={r.pdf_url} target="_blank" rel="noopener noreferrer" style={{ fontFamily: R, fontSize: "10px", color: "#3CCE2A", border: "1.5px solid #DDE8DD", borderRadius: "4px", padding: "5px 12px", textDecoration: "none", letterSpacing: "1px" }}>
                  VIEW PDF
                </a>
              )}
