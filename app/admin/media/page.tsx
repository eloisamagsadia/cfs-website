...
export default function AdminMediaPage() {
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    uploadBtnShadow: { position: "absolute" as const, top: "3px", left: "3px", width: "100%", height: "100%", background: "#080F06", borderRadius: "10px" },
    uploadBtnInner: { position: "relative" as const, display: "inline-flex", alignItems: "center", gap: "8px", fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "12px", fontWeight: 700, background: "#1A8040", color: "#ffffff", padding: "11px 22px", border: "1.5px solid #1B3A2D", borderRadius: "10px", letterSpacing: "1.5px", cursor: "pointer" },
    select: { fontFamily: B, fontSize: "12px", background: "#FFFFFF", color: "#1B3A2D", border: "1.5px solid #DDE8DD", borderRadius: "10px", padding: "10px 14px", outline: "none", cursor: "pointer" },
    searchBar: { display: "flex", gap: "8px", alignItems: "center" },
    searchInput: { fontFamily: B, fontSize: "13px", background: "#FFFFFF", color: "#1B3A2D", border: "1.5px solid #DDE8DD", borderRadius: "10px", padding: "9px 14px", width: "220px", outline: "none" },
    folderTabs: { display: "flex", gap: "6px", flexWrap: "wrap" as const },
    tab: { fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "10px", fontWeight: 700, background: "#F2F7F2", color: "#1B3A2D", border: "1.5px solid transparent", borderRadius: "10px", padding: "8px 14px", cursor: "pointer", letterSpacing: "1.2px", outline: "none", transition: "background 0.15s" },
    tabActive: { fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "10px", fontWeight: 700, background: "#1A8040", color: "#ffffff", border: "1.5px solid #1A8040", borderRadius: "10px", padding: "8px 14px", cursor: "pointer", letterSpacing: "1.2px", outline: "none", boxShadow: "0 2px 8px rgba(26,128,64,0.25)" },
    statsRow: { display: "flex", gap: "10px", flexWrap: "wrap" as const },
    stat: { background: "#FFFFFF", border: "1.5px solid #DDE8DD", borderRadius: "10px", padding: "10px 16px", fontFamily: B, fontSize: "11px", color: "#5A7A60" },
    statVal: { fontFamily: R, fontSize: "16px", color: "#1B3A2D", display: "block", marginBottom: "2px" },
    ...
    checkAll: { fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "10px", fontWeight: 700, color: "#1B3A2D", background: "#E8F0E4", border: "1.5px solid transparent", borderRadius: "10px", padding: "8px 14px", cursor: "pointer", letterSpacing: "1.2px", outline: "none" },
    delSel: { fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "10px", fontWeight: 700, color: "#CC3344", background: "#FFE8EC", border: "1.5px solid #CC334440", borderRadius: "10px", padding: "8px 14px", cursor: "pointer", letterSpacing: "1.2px", outline: "none" },
    viewToggle: { display: "flex", gap: "4px" },
    viewBtn: { background: "#F2F7F2", border: "1.5px solid transparent", borderRadius: "10px", padding: "8px 12px", cursor: "pointer", fontSize: "13px", color: "#5A7A60", outline: "none" },
    viewBtnActive: { background: "#1A8040", border: "1.5px solid #1A8040", borderRadius: "10px", padding: "8px 12px", cursor: "pointer", fontSize: "13px", color: "#ffffff", outline: "none", boxShadow: "0 2px 8px rgba(26,128,64,0.25)" },
    ...
    folderBadge: { position: "absolute" as const, bottom: "6px", left: "6px", background: "rgba(15,42,30,0.72)", borderRadius: "6px", padding: "3px 8px", fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "9px", fontWeight: 700, color: "#ffffff", letterSpacing: "1px", backdropFilter: "blur(4px)" },
    ...
    actBtn: { flex: 1, background: "#E8F0E4", border: "1.5px solid transparent", borderRadius: "8px", padding: "6px 0", fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "10px", fontWeight: 700, color: "#1B3A2D", cursor: "pointer", textAlign: "center" as const, letterSpacing: "1px", outline: "none" },
    actDel: { flex: 1, background: "#FFE8EC", border: "1.5px solid #CC334440", borderRadius: "8px", padding: "6px 0", fontFamily: "var(--font-space-grotesk,'Space Grotesk',sans-serif)", fontSize: "10px", fontWeight: 700, color: "#CC3344", cursor: "pointer", textAlign: "center" as const, letterSpacing: "1px", outline: "none" },
    ...
    <div style={s.page}>
      ...
      {deleteModal && createPortal(
        <>
          ...
          <div style={{ position:"fixed", top:"50%", left:"50%", transform:"translate(-50%,-50%)", background:"#FFFFFF", border:"2px solid #DDE8DD", borderRadius:"16px", padding:"32px 28px", zIndex:9998, width:"320px", maxWidth:"calc(100vw - 32px)", textAlign:"center" }}>
