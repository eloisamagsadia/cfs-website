...
export default function AdminMediaPage() {
  ...
  const s: Record<string, React.CSSProperties> = {
    ...
    tabActive: { fontFamily: B, fontSize: "11px", background: "#1A8040", color: "#ffffff", border: "1px solid #1A8040", borderRadius: "6px", padding: "5px 12px", cursor: "pointer", letterSpacing: "0.5px" },
