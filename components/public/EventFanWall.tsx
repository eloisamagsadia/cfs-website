          ...
          {submitted ? (
            ...
            <div>
              ...
              <div style={{ marginBottom: "8px" }}>
                <label style={{ fontFamily: B, fontSize: "11px", color: url.includes("tiktok") || url.includes("instagram") || url.includes("twitter") || url.includes("x.com") ? "#F07228" : "#5A7A60", letterSpacing: "1px", display: "block", marginBottom: "6px" }}>
              ...
              <button onClick={handleSubmit} disabled={submitting || !url.trim()} style={{ fontFamily: R, fontSize: "12px", background: url.trim() ? "#3CCE2A" : "#F2F7F2", color: url.trim() ? "#080F06" : "#5A7A60", border: "2px solid #080F06", borderRadius: "6px", padding: "10px 24px", cursor: url.trim() ? "pointer" : "not-allowed", letterSpacing: "1.5px" }}>
