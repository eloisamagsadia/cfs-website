...
const icons = {
  ...
  reconcile:  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3v18"/><path d="M5 8h14"/><path d="M7 8l-3 6a3 3 0 0 0 6 0Z"/><path d="M17 8l-3 6a3 3 0 0 0 6 0Z"/></svg>,
...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Reconciliation", href: "/admin/reconciliation",        icon: icons.reconcile },
    ]
  },
  {
    label: "MEMBERS",
