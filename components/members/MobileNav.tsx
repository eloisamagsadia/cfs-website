...
const tabs = [
  ...
  {
    label: "Members",
    href: "/members/community/members",
...
export default function MobileNav() {
  ...
  return (
    <nav style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 50, background: "#F7FAF5", borderTop: "1px solid #DDE8DD", padding: "8px 0 calc(8px + env(safe-area-inset-bottom))", display: "flex", justifyContent: "space-around", alignItems: "center", willChange: "transform", transform: "translateZ(0)" }}>
